...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Augment images for training.')
    augmenter = Augment()
    augmenter.SetupParser(parser)
    args = parser.parse_args()
    print("Arguments received:", args)  # Debugging line
    augmenter.RunProgram(args)
